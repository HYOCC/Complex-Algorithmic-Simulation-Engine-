...
def calcRollServe(ball:ball, accuracy:int, strength:int, spot:dict):# spot: {'gSpot':int, 'sSpot':int}
...
def calcRollReceive(ball:ball, accuracy:int, ballControl:int , spot:dict):# spot: {'gSpot':int, 'sSpot':int} 
...
def calcRollSet(ball:ball, accuracy:int, spot:dict):# spot: {'gSpot':int, 'sSpot':int}
...
def calcRollSpike(ball:ball, accuracy:int, spot:dict):# spot: {'gSpot':int, 'sSpot':int}
